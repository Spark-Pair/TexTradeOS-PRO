      ...
      <div className="mb-4 rounded-3xl border border-gray-300 bg-white p-4">
        <div className="flex items-center gap-3">
          ...
          <div className="max-w-[60%] shrink-0 overflow-x-auto scrollbar-none">
            <div className="relative flex h-[42px] w-max items-center gap-1 rounded-xl bg-gray-200/75 px-1">
              {cats.map((c) => {
                ...
                return (
                  <button
                    ...
                    className={`relative z-0 flex h-8 shrink-0 items-center rounded-lg px-4 text-[13px] font-medium transition-colors duration-200 ${active ? "text-teal-800" : "text-gray-500 hover:text-gray-700"}`}
                  >
                    {active && (
                      <motion.span
