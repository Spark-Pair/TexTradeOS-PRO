  ...
  const featureBlocks = [
    {
      ...
      description: 'Never underestimate a job again. TexTradeOS accurately converts complex design files (DST/EMB) into precise production schedules and exact cost-per-unit figures.',
        ...
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center">
              <h1 className="text-3xl font-light tracking-wider" style={{ color: TEXT_COLOR }}>
                  TexTrade<span className="font-bold" style={{ color: ACCENT_COLOR }}>OS</span>
              </h1>
          </div>
      ...
      <main className="max-w-6xl mx-auto px-8">
        ...
        <section className="pt-24 pb-20 text-center">
            ...
            <p className="text-xl text-gray-700 max-w-4xl mx-auto font-light leading-relaxed">
                TexTradeOS gives you total, elegant control over design complexity, production timelines, and profitability.
            </p>
            ...
            <div className="p-10 rounded-2xl flex items-center justify-center gap-12 border border-gray-300 bg-white shadow-xl">
                ...
                <div className="max-w-2xl text-left">
                    ...
                    <p className="text-lg text-gray-600">
                        TexTradeOS is designed as a focused business operations platform.
                    </p>
                </div>
            </div>
        </section>
        ...
        <footer className="py-12 border-t border-gray-300 text-center text-gray-500 text-sm font-light">
            <p>&copy; {new Date().getFullYear()} TexTradeOS. All rights reserved. | <Link to="/contact" className="hover:text-gray-900 font-normal">Contact</Link></p>
        </footer>
      </main>
