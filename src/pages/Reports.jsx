  ...
  return <div className="reports-page relative z-10 mx-auto flex h-full max-w-7xl flex-col">
    ...
    <div className="min-h-0 flex-1 overflow-auto pb-8">
      ...
      {data && <section className="mt-5 overflow-hidden rounded-3xl border border-gray-300 bg-white">
        ...
        <div className="statement-preview-stage overflow-auto bg-[#e9eeed] p-4 sm:p-6 lg:p-8"><div className="mx-auto w-[297mm] min-h-[210mm] max-w-none bg-white p-[11mm] shadow-[0_12px_40px_rgba(15,23,42,0.14)]"><StatementPaper data={data} type={category}/></div></div>
      </section>}
    </div>
    <style>{`@media print{body *{visibility:hidden!important}.statement-paper,.statement-paper *{visibility:visible!important}.statement-paper{position:absolute!important;left:0!important;top:0!important;width:100%!important;background:#fff!important}.statement-row{break-inside:avoid!important;page-break-inside:avoid!important}.statement-header{break-after:avoid!important;page-break-after:avoid!important}@page{size:A4 landscape;margin:10mm}}`}</style>
  </div>;
}
