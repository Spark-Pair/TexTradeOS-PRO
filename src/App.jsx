...
export default function App() {
  ...
  useEffect(() => {
    const NON_SELECTABLE_INPUT_TYPES = new Set([
      "checkbox", "radio", "file", "date", "month", "time", "datetime-local",
      "color", "range", "button", "submit", "reset", "image", "hidden",
    ]);
    ...
    const handleFocusIn = (event) => {
      ...
      requestAnimationFrame(() => {
        if (document.activeElement === target) selectFieldValue(target);
      });
    };
