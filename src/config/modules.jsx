...
export const MODULE_META = {
  ...
  customers: { icon: UserRound, description: "Customer profiles and accounts", tint: "bg-emerald-200/80 text-emerald-800", card: "bg-emerald-100/60 border-emerald-200 hover:bg-emerald-100 hover:border-emerald-300", action: "bg-emerald-200/70 text-emerald-800 group-hover:bg-emerald-200" },
  suppliers: { icon: Store, description: "Supplier profiles and accounts", tint: "bg-amber-200/80 text-amber-800", card: "bg-amber-100/60 border-amber-200 hover:bg-amber-100 hover:border-amber-300", action: "bg-amber-200/70 text-amber-800 group-hover:bg-amber-200" },
  purchases: { icon: ShoppingCart, description: "Purchase entries and stock intake", tint: "bg-orange-200/80 text-orange-800", card: "bg-orange-100/60 border-orange-200 hover:bg-orange-100 hover:border-orange-300", action: "bg-orange-200/70 text-orange-800 group-hover:bg-orange-200" },
  inventory: { icon: Boxes, description: "Articles, stock and labels", tint: "bg-cyan-200/80 text-cyan-800", card: "bg-cyan-100/60 border-cyan-200 hover:bg-cyan-100 hover:border-cyan-300", action: "bg-cyan-200/70 text-cyan-800 group-hover:bg-cyan-200" },
